<%@ Page Title="Регистрация" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="WebForms.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="ClientName" CssClass="col-md-2 control-label">ClientName</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="ClientName" CssClass="form-control" TextMode="SingleLine" />
